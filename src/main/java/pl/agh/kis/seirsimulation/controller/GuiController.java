...
public class GuiController implements Initializable {
    ...
    private void loadGraphicalMap() {
        load.setOnMouseClicked(mouseEvent -> ofNullable(guiContext.getCountry()).ifPresent(country -> {
            ...
            log.info(country.toLowerCase() + ".png");
...
//                if(MapData.getCellAtIndex(new Pair<>(i, j)).getStateCountMap().stream().mapToInt(Integer::intValue).sum()>MIN_RANDOM_CELL){
